 ...
 * @author jeresabelox
 */
public class SelTurnoFr extends javax.swing.JFrame {

    /**
     * Creates new form SelTurnoFr
     */
    public SelTurnoFr() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblTurnos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "DNI", "Especialidad", "Fecha y Hora", "Seleccionado"
            }
        ) {
        ...
        tblTurnos.setPreferredSize(new java.awt.Dimension(390, 390));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelTurnoFr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelTurnoFr().setVisible(true);
            }
        });
    }
